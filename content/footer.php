            ...
            <div class="search-box-form-wrap">
                ...
                <form action="foo" method="post">
                    <div class="aside-search-form position-relative">
                        ...
                        <input type="text" class="form-control" oninput="search(this.value, 'showresult')" placeholder="Search Title or Price">
...
<script async src="http://www.googletagmanager.com/gtag/js?id=G-QJXQYKFDLK"></script>
...
<!-- Mirrored from template.hasthemes.com/brancy/brancy/index-two.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 30 Apr 2024 11:06:58 GMT -->
