                    ...
                    <div class="row align-items-center">
                        <div class="col-md-7 col-lg-7 col-xl-5">
                            <div class="page-header-content">
                                ...
                                <h2 class="page-header-title"><?=$about['title']?></h2>
                                <h4 class="page-header-sub-title"><?=$about['titles']?></h4>
                                <p class="page-header-desc"><?=$about['detail']?></p>
                            </div>
                        </div>
                        <div class="col-md-5 col-lg-5 col-xl-7">
                            <div class="page-header-thumb">
                                <img src="upload/about/<?=$about['upload_image']?>" width="570" height="669" alt="Image">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <section class="section-space pt-0 mb-n1">
                <div class="container">
                    <div class="about-thumb">
                        <img src="upload/about/<?=$about['upload_images'];?>" alt="Image">
                    </div>
                    <div class="about-content">
                        <h2 class="title"><?=$about['titles']?></h2>
                        <p class="desc"><?=$about['content']?></p>
                    </div>
                </div>
            </section>
                    ...
                    <div class="row mb-n9">
                        <div class="col-md-6 col-lg-4 mb-8">
                            ...
                            <div class="feature-item">
                                ...
                                <p class="desc">Meet our dedicated Support Team — your trusted partners in success. Committed to providing exceptional service and unwavering assistance, our team is here to ensure your experience with us is seamless and satisfying.</p>
                            </div>
                            <!--== End Feature Item ==-->
                        </div>
                        <div class="col-md-6 col-lg-4 mb-8">
                            ...
                            <div class="feature-item">
                                ...
                                <p class="desc">Unlock new opportunities and showcase your expertise with our certification program. At Mimik, we believe in empowering individuals to reach their full potential and stand out in their field.</p>
                            </div>
                            <!--== End Feature Item ==-->
                        </div>
                        <div class="col-md-6 col-lg-4 mb-8">
                            ...
                            <div class="feature-item">
                                ...
                                <p class="desc">Our natural products are crafted with care, free from harsh chemicals and artificial additives. From soothing botanical extracts to nourishing oils, each formulation is thoughtfully curated to deliver effective results while respecting your skin's delicate balance.</p>
                            </div>
                            <!--== End Feature Item ==-->
                        </div>
                    </div>
