                ...
                <div class="col-lg-6">
                    <div class="product-details-thumb">
                        <div id="media-container">
                            <img id="product-image" src="upload/products/<?= $product_data['upload_image']; ?>"
                                width="370" height="450" alt="Image-HasTech">
                            <video id="product-video" autoplay muted loop
                                style="position: absolute; top: 0; left: 0; width: 100%; display: none;">
                                <source src="upload/products/video/<?= $product_relate['upload_video']; ?>"
                                    type="video/mp4">
                            </video>
                        </div>
                        <!-- <img src="upload/products/<?= $product_data['upload_image']; ?>" width="570" height="693"
                            alt="Image"> -->
                    ...
                    <div class="product-details-content">
                        ...
                        <div class="product-details-action">
                            ...
                            <div class="product-details-cart-wishlist">
                                ...
                                <button type="button" class="btn-wishlist"><a
                                        href="https://wa.me/233551468920/?text=Hi,%20I%20got%20your%20number%20from%20your%20website,%20I'm%20about%20making%20this%20payment%20for%20<?= $product_data['title']; ?>%20"
                                        class="envelope-link"><i class="fa fa-envelope"></a></i></button>
