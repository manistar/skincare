               ...
               if(isset($_GET['pID'])){
                ...
                foreach ($video_view as $row) { ?>
                  <tr data-widget="expandable-table" aria-expanded="false">
                      ...
                      <td><video src="../upload/products/video/<?= $row['upload_video']; ?>" style="width: 55px; height: 50px !important;" alt="Image-HasTech"></td>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="?p=view-video&action=edit&id=<?= $row['ID'] ?>">Edit Account</a>
                            <div class="dropdown-divider"></div>
                            <a class="dropdown-item" href="?p=view-video&pID=<?=$row['ID']; ?>&view">Delete Account</a>
                            <div class="dropdown-divider"></div>
